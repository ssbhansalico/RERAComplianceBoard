      ...
      <div className="p-6">
        ...
        <div className="flex gap-5">
          <div className="flex-1 min-w-0 space-y-3">
            <div className="flex">
              <span className="w-[300px] flex-shrink-0 font-bold text-[28px]">પ્રોજેક્ટ નું નામ:</span>
              <span className="flex-1 min-w-0 text-[30px] break-words" style={{ color: "#DC2626" }}>
                {data.projectName || "વિગત ભરો / Fill Details"}
              </span>
            </div>

            <div className="flex">
              <span className="w-[300px] flex-shrink-0 font-bold text-[28px]">રેરા રજીસ્ટ્રેશન નંબર:</span>
              <span className="flex-1 min-w-0 text-[30px] break-words" style={{ color: "#DC2626" }}>
            ...
            <div className="flex">
              <span className="w-[300px] flex-shrink-0 font-bold text-[28px]">પ્રમોટરનું નામ:</span>
              <span className="flex-1 min-w-0 text-[30px] break-words" style={{ color: "#DC2626" }}>
            ...
            <div className="flex">
              <span className="w-[300px] flex-shrink-0 font-bold text-[28px]">પ્રમોટરનો અધિક્રુત ઇ-મેઇલ આઇ.ડી.:</span>
              <span className="flex-1 min-w-0 text-[30px] break-words" style={{ color: "#DC2626" }}>
            ...
            <div className="flex">
              <span className="w-[300px] flex-shrink-0 font-bold text-[28px]">પ્રમોટરનો અધિક્રુત મોબાઈલ નંબર:</span>
              <span className="flex-1 min-w-0 text-[30px] break-words" style={{ color: "#DC2626" }}>
            ...
            <div className="flex">
              <span className="w-[300px] flex-shrink-0 font-bold text-[28px]">ઑથોરાઇઝ્ડ સીગ્નેટરી વ્યકિતનું નામ:</span>
              <span className="flex-1 min-w-0 text-[30px] break-words" style={{ color: "#DC2626" }}>
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-2">
              <div className="flex">
                <span className="font-bold text-[28px] mr-2">પ્રોજેક્ટ પૂર્ણ થવાની તારીખ:</span>
                <span className="text-[30px]" style={{ color: "#DC2626" }}>
                  {formatDate(data.completionDate)}
                </span>
              </div>
              <div className="flex">
                <span className="font-bold text-[28px] mr-2">પ્રોજેક્ટના બાંધકામનો ઉપયોગ:</span>
                <span className="text-[30px]" style={{ color: "#DC2626" }}>
          ...
          <div className="flex-shrink-0 flex flex-col items-center justify-start" style={{ width: "18.75%" }}>
            <div className="text-center w-full mb-2 border-2 border-gray-600 p-2 bg-white/50">
              <p className="text-[16px] font-bold leading-tight mb-1">ગુજરાત રેરાની અધિકૃત વેબ સાઈટ:</p>
              <p className="text-[24px] font-bold leading-tight" style={{ color: "#DC2626" }}>
                https://gujrera.
              </p>
              <p className="text-[24px] font-bold leading-tight" style={{ color: "#DC2626" }}>
                gujarat.gov.in
            ...
            >
              {data.qrCodeImage ? (
                ...
                <div className="w-full h-full flex items-center justify-center border border-dashed border-gray-400">
                  <span className="text-[14px] text-gray-500 text-center">QR Code<br/>Upload</span>
                </div>
              )}
            </div>
            <p className="text-[12px] mt-1 font-medium text-gray-600">22.5cm x 22.5cm</p>
          </div>
        </div>
          ...
          <table className="w-full text-[30px]">
            <thead>
              <tr className="border-b-2 border-gray-600 bg-gray-100">
                <th className="border-r-2 border-gray-600 p-3 text-left font-bold">બ્લોક નંબર</th>
                <th className="border-r-2 border-gray-600 p-3 text-center font-bold">દુકાનની સંખ્યા</th>
                <th className="border-r-2 border-gray-600 p-3 text-center font-bold">ઓફીસની સંખ્યા</th>
                <th className="p-3 text-center font-bold">રહેઠાણની સંખ્યા</th>
              </tr>
            </thead>
            <tbody>
              {data.blocks.length > 0 ? (
                data.blocks.map((block, index) => (
                  <tr key={block.id} className={index < data.blocks.length - 1 ? "border-b border-gray-400" : ""}>
                    <td className="border-r-2 border-gray-600 p-3" style={{ color: "#DC2626" }}>
                      {block.blockName || "-"}
                    </td>
                    <td className="border-r-2 border-gray-600 p-3 text-center" style={{ color: "#DC2626" }}>
                      {block.shops || "0"}
                    </td>
                    <td className="border-r-2 border-gray-600 p-3 text-center" style={{ color: "#DC2626" }}>
                      {block.offices || "0"}
                    </td>
                    <td className="p-3 text-center" style={{ color: "#DC2626" }}>
                      {block.residential || "0"}
                    </td>
                  </tr>
                ))
        ...
        <div className="mt-5 space-y-4">
          <div className="border-2 border-gray-600 p-4">
            <p className="text-[30px] font-bold mb-2">પ્રોજેક્ટના સ્પેસિફિકેશનની વિગતો:</p>
            <p className="text-[30px] break-words" style={{ color: "#DC2626" }}>
              {data.specifications || "વિગત ભરો / Fill Details"}
            </p>
          </div>

          <div className="border-2 border-gray-600 p-4">
            <p className="text-[30px] font-bold mb-2">પ્રોજેક્ટની એમેનિટીઝની વિગતો:</p>
            <p className="text-[30px] break-words" style={{ color: "#DC2626" }}>
        ...
        <div className="mt-5 border-2 border-gray-600 p-4 space-y-3">
          <div className="flex flex-wrap">
            <span className="w-[420px] flex-shrink-0 text-[28px] font-bold">પ્રોજેક્ટ ના રેરા કલેક્શન બેંક એકાઉન્ટ નામ:</span>
            <span className="flex-1 min-w-0 text-[30px] break-words" style={{ color: "#DC2626" }}>
              {data.bankAccountName || "વિગત ભરો / Fill Details"}
            </span>
          </div>
          <div className="flex flex-wrap">
            <span className="w-[420px] flex-shrink-0 text-[28px] font-bold">પ્રોજેક્ટ ના રેરા કલેક્શન બેંક એકાઉન્ટ નંબર:</span>
            <span className="text-[30px]" style={{ color: "#DC2626" }}>
              {maskedAccountNumber || "***********XXXX"}
            </span>
            <span className="text-[20px] text-gray-600 ml-3">(ના નંબર છેલ્લા ૪ અંક જ દર્શાવો)</span>
          </div>
        </div>

        <div className="mt-5 border-2 border-gray-600 p-4">
          <p className="text-[30px] font-bold border-b border-gray-400 pb-2 mb-3">
            પ્રોજેક્ટ લોનની વિગતો
          </p>
          <div className="flex flex-wrap mb-2">
            <span className="w-[480px] flex-shrink-0 text-[28px] font-bold">પ્રોજેક્ટ લોન આપનાર બેંક / નાણા સંસ્થાનું નામ:</span>
            <span className="flex-1 min-w-0 text-[30px] break-words" style={{ color: "#DC2626" }}>
              {loanBankDisplay}
            </span>
          </div>
          <div className="flex flex-wrap gap-x-10 gap-y-2">
            <div className="flex">
              <span className="text-[28px] font-bold mr-3">પ્રોજેક્ટ લોનની રકમ:</span>
              <span className="text-[30px]" style={{ color: "#DC2626" }}>
                {loanAmountDisplay}
              </span>
            </div>
            <div className="flex">
              <span className="text-[28px] font-bold mr-3">પ્રોજેક્ટ લોન લીધા તારીખ:</span>
              <span className="text-[30px]" style={{ color: "#DC2626" }}>
                {loanDateDisplay}
              </span>
            </div>
        ...
        <div className="mt-5 border-2 border-gray-600 p-4">
          <p className="text-[30px] font-bold mb-3 text-center border-b border-gray-400 pb-2">એલોટીઓને જાહેર સુચના</p>
          <ol className="text-[30px] space-y-3 list-decimal pl-8">
            <li>
